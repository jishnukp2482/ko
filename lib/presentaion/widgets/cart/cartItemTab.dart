...
class CartItemMenuTab extends StatefulWidget {
  const CartItemMenuTab({super.key});

  @override
  State<CartItemMenuTab> createState() => _CartItemMenuTabState();
}

class _CartItemMenuTabState extends State<CartItemMenuTab> {
  @override
...
class CartItemTab extends StatelessWidget {
  const CartItemTab(
      {super.key,
    ...
    return Padding(
      ...
      child: SizedBox(
        height: cartOrderModel.description.isEmpty
            ? height * 0.17
            : cartOrderModel.description.length + 1.7 * (height * 0.12),
        width: width * 0.4,
        child: Card(
